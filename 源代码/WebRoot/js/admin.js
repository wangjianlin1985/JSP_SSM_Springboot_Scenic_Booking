		       ...
		       text: "旅游景点管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "Tour/tour_add.jsp"
			    	   	},
			    		{
			    	   		text: "旅游景点管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "Tour/tour_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "定制线路管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "DzLine/dzLine_add.jsp"
			    	   	},
			    		{
			    	   		text: "定制线路管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "DzLine/dzLine_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "订单管理",
			       ...
			       children:
			    	   [{
			    		    ...
			    		    state: "open",
			    		    iconCls: "icon-add-new",
			    		    url: "TourOrder/tourOrder_add.jsp"
			    	   	},
			    		{
			    	   		text: "订单管理",
			    	   		state: "open",
			    	   		iconCls: "icon-manager",
			    	   		url: "TourOrder/tourOrder_query_result.jsp"
			    	    }
			    	   ]
			},{
		       text: "留言管理",
