...
<nav class="navbar navbar-default navbar-fixed-top">
    <div class="container">
        ...
        <div class="navbar-header">
            ...
            <a href="<%=basePath %>index.jsp" class="navbar-brand">旅游网</a>
        </div>
        <!--小屏幕导航按钮和logo-->
        <!--导航-->
        <div class="navbar-collapse collapse">
            <ul class="nav navbar-nav navbar-left">
                ...
                <!-- 
                 ...
                 <li><a href="<%=basePath %>TourOrder/frontlist">订单</a></li> -->
                <li><a href="<%=basePath %>Tour/frontlist">旅游景点</a></li>
                <li><a href="<%=basePath %>DzLine/frontlist">定制线路</a></li>
             ...
             <ul class="nav navbar-nav navbar-right">
                ...
                <li class="dropdown">
                    ...
                    <ul class="dropdown-menu" aria-labelledby="dLabel">
                        ...
                        <li><a href="<%=basePath %>TourOrder/userFrontlist"><span class="glyphicon glyphicon-heart"></span>&nbsp;&nbsp;我的订单</a></li>
                        <li><a href="<%=basePath %>Leaveword/leaveword_frontUserAdd.jsp"><span class="glyphicon glyphicon-user"></span>&nbsp;&nbsp;发布留言</a></li>
                        <li><a href="<%=basePath %>Leaveword/userFrontlist"><span class="glyphicon glyphicon-cog"></span>&nbsp;&nbsp;我的留言</a></li>
